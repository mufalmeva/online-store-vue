<template>
  <div id="nav" class="">
    <div class="nav-items">
      ...
      <router-link
        :to="{ name: 'GenderOverview', params: { gender: 'women' } }"
        class="nav-items__item"
        >Women</router-link
      >
      <router-link
        :to="{ name: 'GenderOverview', params: { gender: 'men' } }"
        class="nav-items__item"
        >Men</router-link
      >
      <div class="float-right ">
        ...
        <router-link :to="{name:'WishListPage',path: '/profile/wishlist'}" class="nav-items__item js-basket hover-opacity" custom-popup-link="dynamic_basket">
    ...
    <hr/>
    <breadcrumb v-if="showBreadCrumbs" :list="list"></breadcrumb>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    showBreadCrumbs(){
      return !this.firstPage || this.$route.meta.isCart;
    },
    crumbs: function() {
